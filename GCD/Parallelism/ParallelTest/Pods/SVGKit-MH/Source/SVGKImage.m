...
+ (SVGKImage*) imageWithData:(NSData *)newNSData
{
	...
	@synchronized(self) {
        ...
        NSLog(@"THREADING: SEMAPHORE BEING USED [%@]", [NSThread currentThread]);
...
{
    NSLog(@"START: initWithParsedSVG: [%@]", parseSource);
	...
	if (self)
	{
        ...
        NSLog(@"FINISHED: initWithParsedSVG: [%@] [%@]", self, parseSource);
	}
    return self;
}
...
- (id)initWithData:(NSData *)data
{
    ...
    NSLog(@"THREADING: WARNING NO SEMAPHORE! [%@]", [NSThread currentThread]);
